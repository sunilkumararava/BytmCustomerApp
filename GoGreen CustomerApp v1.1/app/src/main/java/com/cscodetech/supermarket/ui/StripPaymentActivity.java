...
public class StripPaymentActivity extends AppCompatActivity {
    ...
    com.cscodetech.supermarket.model.PaymentItem paymentItem;
    double amount = 0.0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paymentItem = (com.cscodetech.supermarket.model.PaymentItem) getIntent().getSerializableExtra("detail");
